<template>
  <div class="creator-form-group mt-1">
    <el-form
      ...
      <el-form-item label="Select ERC223 Token Factory" class="mb-0" prop="type">
...
import ConfirmModal from '@/components/erc223/ConfirmModal.vue';
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      resetStatusCreateToken: "erc777/resetStatusCreateToken",
    }),
