<template>
  <el-row :gutter="24">
    ...
    <el-col :span="12">
      <client-only>
        <ERC :title="'Create an ERC-721 Token'"  @onShow="showTransactionSetting = true">
          <template slot="body">
            <form-card 
    ...
    <el-col :span="7">
      <InfoRight :serviceFee="currentServiceFee" type="ERC-721"/>
    </el-col>
    <transaction-setting
...
import FormCard from '@/components/erc721/FormCard.vue'
