<template>
  <el-row :gutter="24">
    ...
    <el-col :span="12">
      <ERC :title="'Create an ERC-777 Token'" @onShow="showTransactionSetting = true">
        <template slot="body">
          <form-card
    ...
    <el-col :span="6">
      <InfoRight :serviceFee="currentServiceFee" type="ERC-777" />
    </el-col>
    <transaction-setting
...
import FormCard from '@/components/erc777/FormCard.vue'
